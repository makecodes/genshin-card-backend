    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, help_text='UUID', primary_key=True, serialize=False, unique=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True, help_text='Data de criação', verbose_name='Criado em')),
                ('updated_at', models.DateTimeField(auto_now=True, db_index=True, help_text='Data de atualização', verbose_name='Atualizado em')),
